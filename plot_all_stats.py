...
graphs = [
    ...
    ("test/rwd_metrics/gaussian_y_pos", None, "std"),
    ("test/rwd_metrics/stretched_gaussian_plateau_y_vel", None, "std"),
    ("test/rwd_metrics/plateau_y_vel", None, "std"),
    ...
    ("test/rwd_metrics/gaussian_y_pos", "test/episode_length/mean", None),
    (
        "test/rwd_metrics/stretched_gaussian_plateau_y_vel",
        "test/episode_length/mean",
        None,
    ),
    ("test/rwd_metrics/plateau_y_vel", "test/episode_length/mean", None),
